...
status: published
tier_list:
  by: strength of the evidence that each topical actually improves or prevents stretch
    marks (striae), drawn from each option's own page and a 2016 review that found
    no topical clearly most effective; early red marks (striae rubrae) respond better
    than old white ones (striae albae), and in-office procedures outperform creams
    for established marks
  caption: No topical is proven to reliably prevent or erase stretch marks; the best-evidenced
    option, a retinoid, helps only early red marks and cannot be used in pregnancy,
    and for established white striae, in-office lasers and microneedling outperform
    any cream.
  items:
  - note: The best-evidenced topical, but only for early red striae (striae rubrae).
      A 2016 review found tretinoin gave "varying results," and it is not used during
      pregnancy, when most stretch marks form, so its practical window is narrow.
      Retinoid details on [[tretinoin]].
    slug: tretinoin
    tier: moderate
  - note: One small, manufacturer-run randomized trial reported improved stretch-mark
      appearance over 8 weeks, but with no effect sizes reported and no independent
...
[^udin]: Ud-Din S, McGeorge D, Bayat A. Topical management of striae distensae (stretch marks): prevention and therapy of striae rubrae and albae. Journal of the European Academy of Dermatology and Venereology, 2016;30(2):211-222. Review; "tretinoin used therapeutically showed varying results whilst cocoa butter and olive oil did not demonstrate any effect"; "there is no topical formulation which is shown to be most effective"; distinguishes early (striae rubrae) from late (striae albae) stages. https://pubmed.ncbi.nlm.nih.gov/26486318/ (accessed 2026-08-21)
[^osman]: Osman H, Usta IM, Rubeiz N, Abu-Rustum R, Charara I, Nassar AH. Cocoa butter lotion for prevention of striae gravidarum: a double-blind, randomised and placebo-controlled trial. BJOG, 2008;115(9):1138-1142. Double-blind RCT, 175 completed; "no difference in the development of SG (45.1% versus 48.8%; P = 0.730)"; concluded cocoa butter "does not appear to reduce the likelihood of developing striae gravidarum." https://pubmed.ncbi.nlm.nih.gov/18715434/ (accessed 2026-08-21)