...
analyzed: '2026-08-27'
assurance: opus
name: Acne Scars (atrophic scars, PIE, and PIH)
slug: acne-scars
status: published
tier_list:
  by: how well each topical option is supported for the flat post-acne MARKS it can
    realistically affect (pigment and, modestly, mild texture); true atrophic scars
    are excluded because their evidence-based treatments are in-office procedures,
    not topicals
  caption: Topicals only meaningfully address the flat marks, brown (PIH) and to a
  ...
  - note: The best-evidenced topical here. Retinoids modestly improve the look of
      ...
      turnover and collagen, but in-office procedures outperform them for established
      atrophic scars. Retinoid evidence on [[tretinoin]] and [[retinoids]].
    slug: tretinoin
    tier: moderate
  - note: For the brown marks (post-inflammatory hyperpigmentation), azelaic acid
      is a well-tolerated fade option; the full pigment ranking is on [[hyperpigmentation]]
      and [[brightening]], not repeated here. Evidence on [[azelaic-acid]].
    slug: azelaic-acid
    tier: moderate
  - note: A gentle pigment-transfer blocker that can help post-acne brown marks as
      an add-on, weaker on its own than azelaic acid or the prescription options on
      [[hyperpigmentation]]. Evidence on [[niacinamide]].
    slug: niacinamide
    tier: minimal
...
[^boen]: Boen M, Jacob C. "A Review and Update of Treatment Options Using the Acne Scar Classification System." Dermatol Surg. 2019 Mar;45(3):411-422. Review using the icepick/rolling/boxcar classification; "divided atrophic acne scars into icepick, rolling, and boxcar scars," and "Therapies for acne scarring included surgical modalities, such as subcision, and punch excision and elevation, injectable fillers, chemical peels, dermabrasion, microneedling, and energy-based devices." https://pubmed.ncbi.nlm.nih.gov/30856634/ (accessed 2026-08-27)
[^elbuluk]: Elbuluk N, Grimes P, Chien A, et al. "The Pathogenesis and Management of Acne-Induced Post-inflammatory Hyperpigmentation." Am J Clin Dermatol. 2021 Nov;22(6):829-836. Review establishing acne-induced post-inflammatory hyperpigmentation as a distinct entity with its own pathogenesis and management, separate from true (atrophic) acne scarring. https://pubmed.ncbi.nlm.nih.gov/34468934/ (accessed 2026-08-27)