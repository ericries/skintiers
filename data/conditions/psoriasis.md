...
status: published
tier_list:
  by: strength of the evidence for the over-the-counter, self-care topicals covered
    on this site. The prescription first-line topicals (corticosteroids, vitamin D
    analogs, and the newer nonsteroidals roflumilast and tapinarof) sit ABOVE these
    and are prescribed and monitored by a dermatologist
  caption: Psoriasis is a chronic immune-mediated disease that is managed, not cured,
    and belongs with a dermatologist. Its first-line topicals are prescription corticosteroids,
    vitamin D analogs, and newer nonsteroidals (roflumilast, tapinarof); the OTC options
    below sit beneath them, with coal tar the strongest self-care topical and salicylic
    acid only an adjunct that lifts scale.
  items:
  - note: An FDA-monograph over-the-counter active that genuinely helps the scaling
      of psoriasis at 0.5-5%, but it is modest, dated, and messy (it stains, smells,
      and raises sun sensitivity) and has been largely superseded by newer topicals.
      Full grade on [[coal-tar]].
    slug: coal-tar
    tier: moderate
  - note: A keratolytic that lifts and softens scale so other topicals can reach the
      skin. It addresses the scale, not the underlying inflammation, so it is an adjunct
      rather than a stand-alone treatment. See [[salicylic-acid]].
    slug: salicylic-acid
    tier: weak
...
The classic sign is a well-defined, raised plaque covered with silvery-white scale, most often on the scalp, elbows, knees, and lower back, though it can appear anywhere.[^intjpharm] It tends to be more sharply bordered than the greasy, yellowish flaking of [[seborrheic-dermatitis]] and the ill-defined, intensely itchy patches of [[atopic-dermatitis]], the two conditions it is most often confused with. It is chronic and relapsing, flaring and settling over time rather than clearing for good. Diagnosis and staging are a clinician's job, especially since psoriasis also involves the joints (psoriatic arthritis) and other body systems; this page is background, not a substitute for a dermatologist.
...
Moderate-to-severe psoriasis is treated with phototherapy and with systemic and biologic drugs prescribed and monitored by a dermatologist. Those are beyond the scope of topical skincare and are not graded here; this page covers only the topical, self-care end of the ladder.

## The tier list

Each active is graded on the strength of its evidence as a self-care topical; the note names where its full evidence is set out. The prescription first-line topicals above these are named in the caption, not ranked, because they are dispensed by a dermatologist rather than bought over the counter.

## The Evidence

The two claims this hub rests on are both drawn from recent secondary literature rather than a single trial. That psoriasis is an immune-mediated disease of keratinocyte proliferation, immune dysregulation, and barrier dysfunction, and that its conventional topical treatments are corticosteroids, vitamin D analogs, and keratolytics, comes from a 2026 review.[^intjpharm] That the FDA-approved-and-labeled topical first-line comprises roflumilast, tapinarof, topical corticosteroids, and vitamin D analogs "in the same category" comes from a 2026 expert position paper on topical psoriasis therapy.[^expert] The OTC actives graded below, coal tar and salicylic acid, carry their own primary sourcing on their pages; neither this page nor the sources here rank them above the prescription first-line.
...
[^intjpharm]: Bobde M, Purohit A, Nema P, et al. Targeting cutaneous inflammation: A review on advanced topical delivery systems and precision medicine in psoriasis. International Journal of Pharmaceutics, 2026 Jul 10;700:127049. "Psoriasis is a chronic autoimmune-mediated inflammatory skin disorder that is characterized by increased keratinocyte proliferation, abnormalities in the immune system, and abnormalities in the epidermal barrier. The conventional topical treatments for the management of psoriasis include corticosteroids, vitamin D analogues, and keratolytic." https://pubmed.ncbi.nlm.nih.gov/42264053/ (accessed 2026-08-22)
[^expert]: Burshtein J, Zakria D, Bhutani T, et al. Topical Prescription Therapy for Psoriasis: An Expert Position Paper on Limitations of Published Guidelines and Treatment Selection With Updated Recommendations. Journal of Clinical and Aesthetic Dermatology, 2026 Jun;19(6):15-21. "Regarding topical psoriasis treatment, initial therapy should be supported by Food and Drug Administration (FDA) approval and labeling. These include topical roflumilast, tapinarof, topical corticosteroids, and vitamin D analogs in the same category, with no utilization management criteria dictating order of use." https://pubmed.ncbi.nlm.nih.gov/42482862/ (accessed 2026-08-22)