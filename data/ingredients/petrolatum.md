...
- **Effect size: notable.** In a large RCT after dermatologic surgery, plain white petrolatum matched a topical antibiotic (bacitracin) on infection rate while causing zero allergic contact dermatitis, and the authors concluded it carries "minimal risk for induction of allergy," whereas bacitracin is a known contact allergen.[^3] "Notable: equivalent to bacitracin ointment, the medicated comparator, on the outcome that matters (infection); the trial authors reported minimal allergy risk. One caveat: petrolatum had more *S. aureus* infections in that trial (below)."
...
- **Evidence quality: anecdotal.** Petrolatum occludes and supports barrier recovery; there is no controlled evidence that it reverses photoaging or remodels dermis. Any such positioning is extrapolation.
